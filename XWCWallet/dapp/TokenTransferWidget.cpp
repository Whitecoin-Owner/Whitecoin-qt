    ...
    ui(new Ui::TokenTransferWidget)
{
    ...
    ui->tokenComboBox->setStyleSheet(COMBOBOX_BORDER_STYLE);
...
void TokenTransferWidget::init()
{
    ...
    transferFeeWidget = new FeeChooseWidget( 0,XWCWallet::getInstance()->feeType,
...
void TokenTransferWidget::on_sendBtn_clicked()
{
    ...
    XWCWallet::getInstance()->postRPC( "TokenTransferWidget-invoke_contract-transfer-" + params, toJsonFormat( "invoke_contract",
...
void TokenTransferWidget::calculateTransferFee()
{
    ...
    XWCWallet::getInstance()->postRPC( "TokenTransferWidget-invoke_contract_testing-transfer-" + params, toJsonFormat( "invoke_contract_testing",
                                     QJsonArray() << ui->accountComboBox->currentText()
                                     << tokenInfo.contractId
                                     << "transfer"  << params));
}
