...
{
    XWCWallet::getInstance()->configFile->beginGroup("/contractTokens");
    ...
    {
        XWCWallet::getInstance()->postRPC( "ContractTokenPage-invoke_contract_offline-tokenSymbol-" + contractId, toJsonFormat( "invoke_contract_offline",
                                                                               QJsonArray() << ui->accountComboBox->currentText() << contractId
                                                                               << "tokenSymbol"  << ""));

        XWCWallet::getInstance()->postRPC( "ContractTokenPage-invoke_contract_offline-precision-" + contractId, toJsonFormat( "invoke_contract_offline",
                                                                               QJsonArray() << ui->accountComboBox->currentText() << contractId
                                                                               << "precision"  << ""));
        XWCWallet::getInstance()->postRPC( "ContractTokenPage-get_contract_info-" + contractId, toJsonFormat( "get_contract_info",
                                                                               QJsonArray() << contractId ));
    }

    XWCWallet::getInstance()->postRPC( "ContractTokenPage-fetchTokensInfo-finish", toJsonFormat( "fetchTokensInfo-finish",
                                                                           QJsonArray()));
}
...
//        {
            ...
            XWCWallet::getInstance()->postRPC( "ContractTokenPage-invoke_contract_offline-balanceOf-" + contractId + "###" + ui->accountComboBox->currentText(),
...
//        }
    ...
    XWCWallet::getInstance()->postRPC( "ContractTokenPage-invoke_contract_offline-fetchTokensBalance-finish",
