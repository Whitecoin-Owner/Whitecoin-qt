...
//    ui->typeWithdrawBtn->setGeometry(ui->typeWithdrawBtn->x(),ui->typeWithdrawBtn->y(),ui->typeWithdrawBtn->width() < 50?50:ui->typeWithdrawBtn->width(),24);
    ...
    ui->accountComboBox->addItems(XWCWallet::getInstance()->getMyMultiSigAddresses());
    ...
    XWCWallet::getInstance()->mainFrame->installBlurEffect(ui->transactionsTableWidget);
}
...
void AllTransactionWidget::showTransactions()
{
    ...
    {
    case AllType:
        typeIds = XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text());
        break;
    case TransferType:
        typeIds = XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_NORMAL);
        break;
    case DepositType:
        typeIds = XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_DEPOSIT);
        break;
    case WithdrawType:
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_WITHDRAW);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_CANCEL_WITHDRAW);
        break;
    case ContractType:
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_CONTRACT_REGISTER);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_CONTRACT_INVOKE);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_CONTRACT_TRANSFER);
        break;
    case MineType:
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_LOCKBALANCE);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_FORECLOSE);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_MINE_INCOME);
        break;
    case GuaranteeType:
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_CREATE_GUARANTEE);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_CANCEL_GUARANTEE);
        break;
    case OtherType:
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_REGISTER_ACCOUNT);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_UPDATE_ACCOUNT);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_BIND_TUNNEL);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_UNBIND_TUNNEL);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_CREATE_MINER);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_CREATE_GUARD);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_ISSUE_ASSET);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_SENATOR_LOCK_BALANCE);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_SIGN_ETH_MULTI_CREATE);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_SIGN_ETH_FINAL);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_SIGN_ETH_COLDHOT_FINAL);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_NAME_TRANSFER);
        break;
    case FeedPriceType:
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_FEED_PRICE);
        break;
    case ProposalType:
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_SPONSOR_PROPOSAL);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_PROPOSAL_APPROVE);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_CITIZEN_PROPOSAL);
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_CITIZEN_RESOLUTION_VOTE);
        break;
    case BonusType:
        typeIds += XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(ui->addressLabel->text(), TRANSACTION_TYPE_OBTAIN_BONUS);
        break;
    default:
        break;
    }
    ...
    case AllTime:
        break;
    case DayTime:
        earliestBlock = XWCWallet::getInstance()->walletInfo.blockHeight - 12 * 60 * 24;
        break;
    case WeekTime:
        earliestBlock = XWCWallet::getInstance()->walletInfo.blockHeight - 12 * 60 * 24 * 7;
        break;
    case MonthTime:
        earliestBlock = XWCWallet::getInstance()->walletInfo.blockHeight - 12 * 60 * 24 * 30;
        break;
    default:
        break;
    }
    ...
    {
        ui->transactionsTableWidget->setRowHeight(i,42);
...
//        }
        ...
        QString guaranteeOrderOwnerAddress = XWCWallet::getInstance()->transactionDB.getGuaranteeOrder(ts.guaranteeId).ownerAddress;
        ...
        case TRANSACTION_TYPE_FEED_PRICE:
        {
            ...
            AssetInfo info = XWCWallet::getInstance()->assetInfoMap.value(baseAssetid);
        ...
        case TRANSACTION_TYPE_CREATE_GUARD:
        {
            ...
            ui->transactionsTableWidget->setItem(i,2, new QTableWidgetItem("-"));
            ui->transactionsTableWidget->setItem(i,3, new QTableWidgetItem("-"));
            ui->transactionsTableWidget->setItem(i,7, new QTableWidgetItem(tr("create wallfacer")));
        ...
        case TRANSACTION_TYPE_SENATOR_LOCK_BALANCE:
        {
            ...
            ui->transactionsTableWidget->setItem(i,7, new QTableWidgetItem(tr("wallfacer lock balance")));
        }
            break;
        case TRANSACTION_TYPE_CANCEL_WITHDRAW:
        {
            QString withdrawTrxId = operationObject.value("txid").toString();
            const TransactionStruct& ts = XWCWallet::getInstance()->transactionDB.getTransactionStruct(withdrawTrxId);
...
//            int state = -1;
//            if(XWCWallet::getInstance()->crosschainWithdrawStateMap.contains(transactionId))
//            {
//                state = XWCWallet::getInstance()->crosschainWithdrawStateMap.value(transactionId);
//            }
...
//            }
        ...
        case TRANSACTION_TYPE_CONTRACT_INVOKE:
        {
            ...
            if(contractAPI == "withdrawAsset")
            {
                 ...
                 AssetInfo info  = XWCWallet::getInstance()->assetInfoMap.value(XWCWallet::getInstance()->getAssetId(assetSymbol));
        ...
        case TRANSACTION_TYPE_CONTRACT_TRANSFER:
        {
            ...
            ContractInvokeObject cio = XWCWallet::getInstance()->transactionDB.getContractInvokeObject(ts.transactionId);
        ...
        case TRANSACTION_TYPE_CANCEL_GUARANTEE:
        {
            ...
            GuaranteeOrder go = XWCWallet::getInstance()->transactionDB.getGuaranteeOrder(cancelGuaranteeOrderId);
            QString str;
            if(!go.id.isEmpty())
            {
                AssetInfo originAssetInfo = XWCWallet::getInstance()->assetInfoMap.value(go.originAssetAmount.assetId);
                AssetInfo targetAssetInfo = XWCWallet::getInstance()->assetInfoMap.value(go.targetAssetAmount.assetId);
        ...
        case TRANSACTION_TYPE_OBTAIN_BONUS:
        {
            ...
            foreach (QJsonValue v, bonusBalanceArray)
            {
                ...
                AssetInfo amountAssetInfo = XWCWallet::getInstance()->assetInfoMap.value( XWCWallet::getInstance()->getAssetId( assetSymbol));
        ...
        case TRANSACTION_TYPE_SIGN_ETH_MULTI_CREATE:
        {
            ...
            ui->transactionsTableWidget->setItem(i,7, new QTableWidgetItem(tr("wallfacer sign to create %1 multi-sig account").arg(chainType)));
        ...
        case TRANSACTION_TYPE_SIGN_ETH_FINAL:
        {
            ui->transactionsTableWidget->setItem(i,2, new QTableWidgetItem("-"));
            ui->transactionsTableWidget->setItem(i,3, new QTableWidgetItem("-"));
            ui->transactionsTableWidget->setItem(i,7, new QTableWidgetItem(tr("wallfacer sign ETH trx")));
        ...
        case TRANSACTION_TYPE_SIGN_ETH_COLDHOT_FINAL:
        {
            ui->transactionsTableWidget->setItem(i,2, new QTableWidgetItem("-"));
            ui->transactionsTableWidget->setItem(i,3, new QTableWidgetItem("-"));
            ui->transactionsTableWidget->setItem(i,7, new QTableWidgetItem(tr("wallfacer sign ETH cold-hot trx")));
        ...
        case 1:
        {
            GuaranteeOrder go = XWCWallet::getInstance()->transactionDB.getGuaranteeOrder(ts.guaranteeId);
            AssetInfo targetAssetInfo = XWCWallet::getInstance()->assetInfoMap.value(go.targetAssetAmount.assetId);
...
void AllTransactionWidget::paintEvent(QPaintEvent *)
{
    ...
    painter.drawRect(0,60,this->width(),98);
}

double AllTransactionWidget::calculateGuaranteeOrderAmount(QString _guaranteeId, double _feeAmount)
{
    GuaranteeOrder go = XWCWallet::getInstance()->transactionDB.getGuaranteeOrder(_guaranteeId);
...
void AllTransactionWidget::on_clearDBBtn_clicked()
{
    ...
    if(commonDialog.pop())
    {
        XWCWallet::getInstance()->transactionDB.clearAllDBs();
        ...
        XWCWallet::getInstance()->blockTrxFetched = 0;
