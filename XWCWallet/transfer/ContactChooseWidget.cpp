...
public:
        ...
        ,initSuccess(true)
    {
        ...
        {
            contactFilePath = XWCWallet::getInstance()->configFile->value("/settings/chainPath").toString() + "/contacts.dat";
        }
        else
        {
            contactFilePath = XWCWallet::getInstance()->appDataPath + "/contacts.dat";
        }
    }
public:
