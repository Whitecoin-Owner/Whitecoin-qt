...
//    connect( bgGroup, SIGNAL(buttonToggled(int, bool), this, SLOT(on_bgGroup_toggled(int, bool)));
    ...
    FeeChooseWidget *feeWidget = new FeeChooseWidget(XWCWallet::getInstance()->feeChargeInfo.citizenResolution.toDouble(),
                                                     XWCWallet::getInstance()->feeType,account);
...
void CitizenResolutionDialog::on_okBtn_clicked()
{
    ...
    XWCWallet::getInstance()->postRPC("CitizenResolutionDialog-cast_vote",toJsonFormat("cast_vote",
