...
void ChangeSenatorDialog::InitWidget()
{
    ...
    connect(XWCWallet::getInstance(),&XWCWallet::jsonDataUpdated,this,&ChangeSenatorDialog::jsonDataUpdated);


    FeeChooseWidget *feeWidget = new FeeChooseWidget(XWCWallet::getInstance()->feeChargeInfo.ChangeSenatorFee.toDouble(),
                                                     XWCWallet::getInstance()->feeType,ui->account->currentText());
...
//    QMap<QString,AccountInfo> account(XWCWallet::getInstance()->accountInfoMap);
