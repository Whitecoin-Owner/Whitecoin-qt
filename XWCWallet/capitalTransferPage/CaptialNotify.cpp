...
static const QString XWC_ASSET_ID = "1.3.0";
    ...
    , _p(new DataPrivate())
{
    ...
    connect( XWCWallet::getInstance(), &XWCWallet::jsonDataUpdated, this, &CaptialNotify::jsonDataUpdated);
...
void CaptialNotify::PostQueryTunnelAddress(const QString &accountName, const QString &symbol)
{
    ...
    XWCWallet::getInstance()->postRPC( "CaptialNotify-get_binding_account-"+accountName,
...
{
    XWCWallet::getInstance()->postRPC( "CaptialNotify-finish-tunnel",
...
{
    XWCWallet::getInstance()->postRPC( "CaptialNotify-finish-money",
