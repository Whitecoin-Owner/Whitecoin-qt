...
//    ui->assetTableWidget->horizontalHeader()->setFixedHeight(40);
    ...
    XWCWallet::getInstance()->mainFrame->installBlurEffect(ui->assetTableWidget);
...
void AssetPage::showAssetsInfo()
{
    ...
    {
        ui->assetTableWidget->setRowHeight(i,42);
        ...
        ui->assetTableWidget->setItem(i,4,new QTableWidgetItem(XWCWallet::getInstance()->guardAccountIdToName(assetInfo.issuer)));
