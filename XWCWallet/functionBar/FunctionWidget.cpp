...
void FunctionWidget::ShowMoreWidgetSlots()
{
    ...
    helpMenu->setStyleSheet(
                "QMenu {border:none;background-color:rgb(77,84,230);width:130px;color:rgb(197,198,245);font-size:14px;}"
                "QMenu::item {padding:5px 21px;width:130px;color:white;}"
                "QMenu::item:selected {background-color:rgb(71,77,205);}"
...
void FunctionWidget::ShowSettingWidgetSlots()
{
    ...
    SetDialog setDialog;
    connect(&setDialog,SIGNAL(settingSaved()),XWCWallet::getInstance()->mainFrame,SLOT(settingSaved()));
    setDialog.pop();
}
...
//                );
    ...
    _p->contextMenu->setStyleSheet(
                "QMenu {border:none;background-color:rgb(77,84,230);width:128px;color:rgb(197,198,245);font-size:14px;}"
...
//    ui->toolButton_more->setIcon(QIcon(":/functionBar/more.png"));
    ...
    ui->toolButton_account->setStyleSheet("QToolButton{background-image:url(:/functionBar/menubar_account_ico.png);background-repeat: no-repeat;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                          "QToolButton:hover{background-color:rgba(31,22,59,0.3);}"
                                          "QToolButton:checked{background-color:transparent;background-image:url(:/functionBar/menubar_account_ico_select.png);}");
    ui->toolButton_exchange->setStyleSheet("QToolButton{background-image:url(:/functionBar/menubar_exchange_ico.png);background-repeat: no-repeat;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                           "QToolButton:hover{background-color:rgba(31,22,59,0.3);}"
                                           "QToolButton:checked{background-color:transparent;background-image:url(:/functionBar/menubar_exchange_ico_select.png);}");
    ui->toolButton_advanced->setStyleSheet("QToolButton{background-image:url(:/functionBar/menubar_senior_ico.png);background-repeat: no-repeat;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                           "QToolButton:hover{background-color:rgba(31,22,59,0.3);}"
                                           "QToolButton:checked{background-color:transparent;background-image:url(:/functionBar/menubar_senior_ico_select.png);}");
    ui->toolButton_contact->setStyleSheet("QToolButton{background-image:url(:/functionBar/menubar_name_ico.png);background-repeat: no-repeat;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                          "QToolButton:hover{background-color:rgba(31,22,59,0.3);}"
                                          "QToolButton:checked{background-color:transparent;background-image:url(:/functionBar/menubar_name_ico_select.png);}");
    ui->toolButton_guard->setStyleSheet("QToolButton{background-image:url(:/functionBar/menubar_senator_ico.png);background-repeat: no-repeat;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                        "QToolButton:hover{background-color:rgba(31,22,59,0.3);}"
                                        "QToolButton:checked{background-color:transparent;background-image:url(:/functionBar/menubar_senator_ico_select.png);}");
    ui->toolButton_citizen->setStyleSheet("QToolButton{background-image:url(:/functionBar/menubar_citizen_ico.png);background-repeat: no-repeat;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                          "QToolButton:hover{background-color:rgba(31,22,59,0.3);}"
                                          "QToolButton:checked{background-color:transparent;background-image:url(:/functionBar/menubar_citizen_ico_select.png);}");
    ui->toolButton_more->setStyleSheet("QToolButton{background-image:url(:/functionBar/more.png);background-repeat: no-repeat;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                       "QToolButton:hover{background-color:rgba(31,22,59,0.3);}"
                                       "QToolButton:checked{background-color:transparent;background-color:rgba(31,22,59,0.3);background-image:url(:/functionBar/more_checked.png);}");
}
...
void FunctionWidget::paintEvent(QPaintEvent *)
{
    ...
    painter.setBrush(QBrush(QColor(56,74,179)));
