...
void ContactSearchWidget::InitStyle()
{
    ...
    QPalette palette;
    palette.setColor(QPalette::Window, QColor(83,107,215));
    setPalette(palette);


    setStyleSheet("QPushButton{ background:transparent;}"
                  "QLineEdit{background-color:transparent;font-size:12px;border:none;border-radius:0px;color:white;border-bottom:1px solid rgb(70,90,197);}"
                  );
