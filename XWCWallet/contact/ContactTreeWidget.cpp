...
void ContactTreeWidget::initTreeStyle()
{
    ...
    setStyleSheet("QWidget{border:none;}"
                  ...
                  "QTreeView{background:rgb(83,107,215);border:none;padding-left:0px;\
                      color:rgb(192,199,238);font-size:14px;font-family:\"Microsoft YaHei UI Light\";outline:0px;margin-left:5px;}"
        ...
        "QTreeView::branch::hover::adjoins-item,QTreeView::branch::hover::!adjoins-item,QTreeView::item::hover{background:rgb(83,107,215);}"
