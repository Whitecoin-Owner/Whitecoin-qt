...
bool TransactionDB::init()
{
    ...
    QString dirStr = XWCWallet::getInstance()->walletConfigPath + "/transactionDB";
    QDir dir;
    ...
    leveldb::Status status = leveldb::DB::Open(options,QString(XWCWallet::getInstance()->walletConfigPath + "/transactionDB/transactionStruct").toStdString(), &m_transactionStructDB);
    leveldb::Status status2 = leveldb::DB::Open(options,QString(XWCWallet::getInstance()->walletConfigPath + "/transactionDB/accountTransactionIds").toStdString(), &m_accountTransactionIdsDB);
    leveldb::Status status3 = leveldb::DB::Open(options,QString(XWCWallet::getInstance()->walletConfigPath + "/transactionDB/guaranteeOrder").toStdString(), &m_guaranteeOrderDB);
    leveldb::Status status4 = leveldb::DB::Open(options,QString(XWCWallet::getInstance()->walletConfigPath + "/transactionDB/contractInvokeObject").toStdString(), &m_contractInvokeObjectDB);
    leveldb::Status status5 = leveldb::DB::Open(options,QString(XWCWallet::getInstance()->walletConfigPath + "/transactionDB/nameTransferTrx").toStdString(), &m_nameTransferTrxDB);
...
bool TransactionDB::clearAllDBs()
{
    ...
    leveldb::Options options;
    leveldb::DestroyDB((XWCWallet::getInstance()->walletConfigPath + "/transactionDB/transactionStruct").toStdString(), options);
    leveldb::DestroyDB((XWCWallet::getInstance()->walletConfigPath + "/transactionDB/accountTransactionIds").toStdString(), options);
    leveldb::DestroyDB((XWCWallet::getInstance()->walletConfigPath + "/transactionDB/guaranteeOrder").toStdString(), options);
