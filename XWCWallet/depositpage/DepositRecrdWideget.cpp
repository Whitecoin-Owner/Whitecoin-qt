...
//    ui->depositRecordTableWidget->setColumnWidth(5,70);
    ...
    XWCWallet::getInstance()->mainFrame->installBlurEffect(ui->depositRecordTableWidget);
    init();
}
...
void DepositRecrdWideget::showDepositRecord(QString _tunnelAddress)
{
    ...
    TransactionTypeIds typeIds = XWCWallet::getInstance()->transactionDB.getAccountTransactionTypeIdsByType(_tunnelAddress,TRANSACTION_TYPE_DEPOSIT);
    ...
    {
        ui->depositRecordTableWidget->setRowHeight(i,42);
